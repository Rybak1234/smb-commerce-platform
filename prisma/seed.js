...
async function main() {
  ...
  const productData = [
    // === ABARROTES ===
    { name: "Arroz Grano de Oro 5kg", slug: "arroz-grano-de-oro-5kg", description: "Arroz grano largo de primera calidad, cultivado en los llanos orientales de Bolivia. Ideal para el almuerzo familiar.", price: 45, images: ["https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600&h=600&fit=crop"], categoryId: cats["abarrotes"].id, vendorId: vendor1.id, brand: "Grano de Oro", tags: ["arroz", "abarrotes", "básico"], badge: "Mas vendido", featured: true, stock: 200, sku: "ABR-ARR-5KG", weight: 5, avgRating: 4.7, reviewCount: 45, salesCount: 320 },
    { name: "Aceite de Soya Fino 900ml", slug: "aceite-soya-fino-900ml", description: "Aceite de soya refinado, ideal para cocinar y freír. Producto boliviano de alta calidad.", price: 18, images: ["https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=600&h=600&fit=crop"], categoryId: cats["abarrotes"].id, vendorId: vendor1.id, brand: "Fino", tags: ["aceite", "cocina", "abarrotes"], stock: 150, sku: "ABR-ACE-900", weight: 0.9, avgRating: 4.5, reviewCount: 32, salesCount: 210 },
    { name: "Azúcar Bermejo 1kg", slug: "azucar-bermejo-1kg", description: "Azúcar blanca refinada de los ingenios de Bermejo, Tarija.", price: 8, images: ["https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=600&h=600&fit=crop"], categoryId: cats["abarrotes"].id, vendorId: vendor1.id, brand: "Bermejo", tags: ["azúcar", "básico", "tarija"], stock: 300, sku: "ABR-AZU-1KG", weight: 1, avgRating: 4.3, reviewCount: 18, salesCount: 280 },
    { name: "Fideos Don Vittorio Spaghetti 500g", slug: "fideos-don-vittorio-500g", description: "Fideos de sémola de trigo duro. Textura firme al dente.", price: 12, images: ["https://images.unsplash.com/photo-1551462147-ff29053bfc14?w=600&h=600&fit=crop"], categoryId: cats["abarrotes"].id, vendorId: vendor1.id, brand: "Don Vittorio", tags: ["fideos", "pasta", "abarrotes"], stock: 180, sku: "ABR-FID-500", weight: 0.5, avgRating: 4.6, reviewCount: 25, salesCount: 190 },
    { name: "Atún Real en Aceite 170g", slug: "atun-real-aceite-170g", description: "Atún en trozos en aceite vegetal. Práctico para ensaladas y sándwiches.", price: 15, images: ["https://images.unsplash.com/photo-1597733336794-12d05021d510?w=600&h=600&fit=crop"], categoryId: cats["abarrotes"].id, vendorId: vendor1.id, brand: "Real", tags: ["atún", "enlatado", "proteína"], stock: 120, sku: "ABR-ATU-170", weight: 0.17, avgRating: 4.4, reviewCount: 20, salesCount: 145 },

    // === L�CTEOS Y HUEVOS ===
    { name: "Leche PIL Entera 1L", slug: "leche-pil-entera-1l", description: "Leche entera pasteurizada PIL. La leche de la familia boliviana.", price: 9, originalPrice: 11, images: ["https://images.unsplash.com/photo-1563636619-e9143da7973b?w=600&h=600&fit=crop"], categoryId: cats["lacteos-huevos"].id, vendorId: vendor1.id, brand: "PIL", tags: ["leche", "lácteo", "pil"], badge: "Popular", featured: true, trending: true, stock: 100, sku: "LAC-PIL-1L", weight: 1, avgRating: 4.8, reviewCount: 67, salesCount: 450 },
    { name: "Yogur Delizia Frutilla 1L", slug: "yogur-delizia-frutilla-1l", description: "Yogur bebible sabor frutilla. Delicioso y nutritivo.", price: 14, images: ["https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&h=600&fit=crop"], categoryId: cats["lacteos-huevos"].id, vendorId: vendor1.id, brand: "Delizia", tags: ["yogur", "frutilla", "lácteo"], stock: 80, sku: "LAC-YOG-FRU", weight: 1, avgRating: 4.6, reviewCount: 35, salesCount: 180 },
    ...
    // === FRUTAS Y VERDURAS ===
    { name: "Plátano de los Yungas 1kg", slug: "platano-yungas-1kg", description: "Plátanos frescos de los Yungas de La Paz. Dulces y maduros.", price: 8, images: ["https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&h=600&fit=crop"], categoryId: cats["frutas-verduras"].id, vendorId: vendor1.id, brand: "Yungas", tags: ["plátano", "fruta", "yungas", "la paz"], badge: "Del día", featured: true, stock: 100, sku: "FRU-PLA-1KG", weight: 1, avgRating: 4.7, reviewCount: 55, salesCount: 380 },
    ...
    { name: "Papa Huaycha 5kg", slug: "papa-huaycha-5kg", description: "Papa Huaycha de las tierras altas. La papa más popular de Bolivia.", price: 25, images: ["https://images.unsplash.com/photo-1518977676601-b53f82ber40f?w=600&h=600&fit=crop"], categoryId: cats["frutas-verduras"].id, vendorId: vendor1.id, brand: "Altiplano", tags: ["papa", "tubérculo", "huaycha"], stock: 80, sku: "FRU-PAP-5KG", weight: 5, avgRating: 4.6, reviewCount: 40, salesCount: 250 },

    // === PANADER�A ===
    { name: "Marraqueta Paceña x10", slug: "marraqueta-pacena-x10", description: "Marraquetas crujientes recién horneadas. El pan favorito de La Paz.", price: 10, images: ["https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&h=600&fit=crop"], categoryId: cats["panaderia"].id, vendorId: vendor1.id, brand: "Panadería SB", tags: ["marraqueta", "pan", "la paz"], badge: "Recién horneado", featured: true, stock: 200, sku: "PAN-MAR-10", weight: 0.6, avgRating: 4.9, reviewCount: 90, salesCount: 500 },
    { name: "Empanadas Salteñas x6", slug: "empanadas-saltenas-x6", description: "Salteñas jugosas con relleno de carne, papa y ají. Tradición boliviana.", price: 30, images: ["https://images.unsplash.com/photo-1601924582970-9238bcb495d9?w=600&h=600&fit=crop"], categoryId: cats["panaderia"].id, vendorId: vendor1.id, brand: "Panadería SB", tags: ["salteña", "empanada", "tradición"], trending: true, stock: 50, sku: "PAN-SAL-6", weight: 0.8, avgRating: 4.9, reviewCount: 75, salesCount: 340 },

    // === BEBIDAS ===
    { name: "Api Morado en Polvo 500g", slug: "api-morado-polvo-500g", description: "Mezcla para preparar Api morado, la bebida caliente tradicional boliviana a base de maíz morado.", price: 18, images: ["https://images.unsplash.com/photo-1577003811926-53b288a6e5d0?w=600&h=600&fit=crop"], categoryId: cats["bebidas"].id, vendorId: vendor1.id, brand: "Tradición", tags: ["api", "maíz", "tradición", "boliviana"], badge: "Tradición", featured: true, stock: 90, sku: "BEB-API-500", weight: 0.5, avgRating: 4.8, reviewCount: 60, salesCount: 280 },
    { name: "Cerveza Paceña Six Pack", slug: "cerveza-pacena-six-pack", description: "La cerveza boliviana más popular. 6 botellas de 330ml.", price: 48, originalPrice: 55, images: ["https://images.unsplash.com/photo-1608270586620-248524c67de9?w=600&h=600&fit=crop"], categoryId: cats["bebidas"].id, vendorId: vendor1.id, brand: "Paceña", tags: ["cerveza", "paceña", "bebida"], trending: true, stock: 120, sku: "BEB-PAC-6PK", weight: 2.5, avgRating: 4.7, reviewCount: 48, salesCount: 300 },
    ...
    // === LIMPIEZA Y HOGAR ===
    { name: "Detergente Omo Matic 3kg", slug: "detergente-omo-matic-3kg", description: "Detergente en polvo para lavadora automática. Limpieza profunda.", price: 55, images: ["https://images.unsplash.com/photo-1585441695325-21557ef66366?w=600&h=600&fit=crop"], categoryId: cats["limpieza-hogar"].id, vendorId: vendor1.id, brand: "Omo", tags: ["detergente", "limpieza", "lavandería"], stock: 80, sku: "LIM-OMO-3KG", weight: 3, avgRating: 4.5, reviewCount: 22, salesCount: 130 },
    { name: "Lavandina Clorox 1L", slug: "lavandina-clorox-1l", description: "Desinfectante multiusos. Elimina 99.9% de gérmenes.", price: 12, images: ["https://images.unsplash.com/photo-1622394205098-eda3c9566115?w=600&h=600&fit=crop"], categoryId: cats["limpieza-hogar"].id, vendorId: vendor1.id, brand: "Clorox", tags: ["lavandina", "desinfectante", "limpieza"], stock: 100, sku: "LIM-CLO-1L", weight: 1, avgRating: 4.4, reviewCount: 18, salesCount: 110 },
    ...
    { name: "Crema Nivea Lata 250ml", slug: "crema-nivea-250ml", description: "Crema hidratante multiusos. Protección para la piel seca del altiplano.", price: 42, images: ["https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?w=600&h=600&fit=crop"], categoryId: cats["cuidado-personal"].id, vendorId: vendor1.id, brand: "Nivea", tags: ["crema", "hidratante", "piel"], stock: 60, sku: "CUI-NIV-250", weight: 0.3, avgRating: 4.7, reviewCount: 35, salesCount: 120 },

    // === MODA BOLIVIANA — 9 DEPARTAMENTOS ===
    { name: "Aguayo Moderno", slug: "aguayo-moderno-la-paz", description: "Aguayo tejido a mano con diseños contemporáneos inspirados en los textiles paceños. Colores azul y blanco representando el cielo del Illimani.", price: 180, originalPrice: 220, images: ["https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=600&h=600&fit=crop"], categoryId: cats["ropa-y-accesorios"].id, vendorId: vendor2.id, brand: "Moda 9D", tags: ["aguayo", "la paz", "textil", "artesanal"], badge: "La Paz", featured: true, trending: true, stock: 25, sku: "MOD-LP-001", weight: 0.3, avgRating: 4.9, reviewCount: 45, salesCount: 89 },
    { name: "Chaleco Tejido", slug: "chaleco-tejido-cochabamba", description: "Chaleco de alpaca con bordados florales del Valle de Cochabamba. Colores cálidos tierra y naranja.", price: 250, images: ["https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=600&h=600&fit=crop"], categoryId: cats["ropa-y-accesorios"].id, vendorId: vendor2.id, brand: "Moda 9D", tags: ["chaleco", "cochabamba", "alpaca", "tejido"], badge: "Cochabamba", featured: true, stock: 20, sku: "MOD-CB-001", weight: 0.4, avgRating: 4.8, reviewCount: 32, salesCount: 56 },
    { name: "Camisa Tropical", slug: "camisa-tropical-santa-cruz", description: "Camisa ligera con estampado de flora y fauna del oriente boliviano. Diseño moderno con motivos de la Chiquitanía.", price: 150, images: ["https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=600&h=600&fit=crop"], categoryId: cats["ropa-y-accesorios"].id, vendorId: vendor2.id, brand: "Moda 9D", tags: ["camisa", "santa cruz", "tropical", "oriente"], badge: "Santa Cruz", featured: true, stock: 30, sku: "MOD-SC-001", weight: 0.2, avgRating: 4.7, reviewCount: 28, salesCount: 72 },
    ...
    { name: "Bolso Minero", slug: "bolso-minero-potosi", description: "Bolso de cuero artesanal con acabados metálicos inspirados en la tradición minera del Cerro Rico de Potosí.", price: 200, images: ["https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=600&h=600&fit=crop"], categoryId: cats["ropa-y-accesorios"].id, vendorId: vendor2.id, brand: "Moda 9D", tags: ["bolso", "potosí", "cuero", "minero"], badge: "Potosi", stock: 18, sku: "MOD-PO-001", weight: 0.6, avgRating: 4.7, reviewCount: 22, salesCount: 38 },
    { name: "Vestido Vendimia", slug: "vestido-vendimia-tarija", description: "Vestido floral inspirado en la Fiesta de la Vendimia de Tarija. Tela ligera con estampados de viñedos en tonos rosa y púrpura.", price: 280, images: ["https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=600&h=600&fit=crop"], categoryId: cats["ropa-y-accesorios"].id, vendorId: vendor2.id, brand: "Moda 9D", tags: ["vestido", "tarija", "vendimia", "floral"], badge: "Tarija", featured: true, stock: 12, sku: "MOD-TJ-001", weight: 0.3, avgRating: 4.8, reviewCount: 35, salesCount: 42 },
    ...
    { name: "Hamaca Artesanal", slug: "hamaca-artesanal-beni", description: "Hamaca tejida a mano por artesanas del Beni. Colores turquesa y verde que evocan los ríos y la selva amazónica.", price: 350, images: ["https://images.unsplash.com/photo-1519643381401-22c77e60520e?w=600&h=600&fit=crop"], categoryId: cats["ropa-y-accesorios"].id, vendorId: vendor2.id, brand: "Moda 9D", tags: ["hamaca", "beni", "artesanal", "amazónico"], badge: "Beni", stock: 10, sku: "MOD-BN-001", weight: 1.2, avgRating: 4.9, reviewCount: 15, salesCount: 22 },
    { name: "Mochila Amazónica", slug: "mochila-amazonica-pando", description: "Mochila ecológica con materiales sostenibles de la Amazonía. Diseño verde con motivos de la selva pandina.", price: 220, images: ["https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=600&fit=crop"], categoryId: cats["ropa-y-accesorios"].id, vendorId: vendor2.id, brand: "Moda 9D", tags: ["mochila", "pando", "amazónica", "ecológica"], badge: "Pando", stock: 16, sku: "MOD-PA-001", weight: 0.4, avgRating: 4.7, reviewCount: 12, salesCount: 28 },

    // === ELECTRÓNICA ===
    { name: "Licuadora Oster 3 Velocidades", slug: "licuadora-oster-3vel", description: "Licuadora Oster clásica con vaso de vidrio y 3 velocidades. Ideal para jugos y licuados.", price: 280, images: ["https://images.unsplash.com/photo-1570222094114-d054a817e56b?w=600&h=600&fit=crop"], categoryId: cats["electronica"].id, vendorId: vendor1.id, brand: "Oster", tags: ["licuadora", "cocina", "electrodoméstico"], stock: 35, sku: "ELE-OST-LIC", weight: 3.5, avgRating: 4.5, reviewCount: 20, salesCount: 65 },
    { name: "Celular Xiaomi Redmi Note 13", slug: "xiaomi-redmi-note-13", description: "Smartphone Xiaomi Redmi Note 13 128GB. Pantalla AMOLED 6.67\", cámara 108MP, batería 5000mAh. Compatible con Entel, Tigo y Viva.", price: 1450, originalPrice: 1700, images: ["https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=600&h=600&fit=crop"], categoryId: cats["electronica"].id, vendorId: vendor1.id, brand: "Xiaomi", tags: ["celular", "xiaomi", "smartphone", "5g"], badge: "Tecnología", featured: true, trending: true, stock: 25, sku: "ELE-XIA-RN13", weight: 0.2, avgRating: 4.7, reviewCount: 55, salesCount: 120 },
  ];
